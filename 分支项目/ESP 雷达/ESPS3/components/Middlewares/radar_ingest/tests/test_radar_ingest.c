...
static const char *valid_c52_json =
    ...
    "{\"device_id\":\"sensair_shuttle_02\",\"room_id\":\"bedroom\",\"link_state\":5,\"sample_valid\":1,"
...
static void test_schema_and_identity_rejection(void)
{
    const char wrong_identity[] =
        ...
        "{\"device_id\":\"sensair_shuttle_02\",\"room_id\":\"bedroom\",\"link_state\":5,\"sample_valid\":0,"
    ...
    const char invalid_confidence[] =
        "{\"p\":3,\"id\":1,\"t\":\"radar\",\"u\":1,\"q\":1,\"v\":"
        "{\"device_id\":\"sensair_shuttle_01\",\"room_id\":\"living_room\",\"link_state\":5,\"sample_valid\":1,"
