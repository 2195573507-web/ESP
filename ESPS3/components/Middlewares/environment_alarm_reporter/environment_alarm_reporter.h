...
typedef void (*environment_alarm_observer_t)(const alarm_event_t *event, void *context);
...
/** @brief Registers one non-owning observer called after an engine event is deep-copied. */
