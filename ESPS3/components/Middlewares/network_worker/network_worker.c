...
esp_err_t network_worker_init(void)
{
    ...
    if (s_upload_task == NULL) {
        ...
        if (created != pdPASS) {
            s_upload_task = NULL;
            return network_worker_init_failed("upload_task_psram");
        }
    }
    if (s_command_task == NULL) {
        ...
        if (created != pdPASS) {
            s_command_task = NULL;
            return network_worker_init_failed("command_task_psram");
        }
    }
    if (s_snapshot_task == NULL) {
        ...
        if (created != pdPASS) {
            s_snapshot_task = NULL;
            return network_worker_init_failed("snapshot_task_psram");
        }
    }
    ESP_LOGI(TAG,
