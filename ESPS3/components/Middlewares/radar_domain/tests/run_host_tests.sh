...
OUTPUT="$SCRIPT_DIR/radar_ingest_host_tests"
SPATIAL_OUTPUT="$SCRIPT_DIR/radar_spatial_host_tests"
GATEWAY_OUTPUT="$SCRIPT_DIR/radar_gateway_host_tests"
ADAPTER_OUTPUT="$SCRIPT_DIR/radar_adapter_host_tests"
